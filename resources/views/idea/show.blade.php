<x-app-layout>
        ...
        <div class="idea-container shadow-card  transition duration-150 ease-in bg-white rounded-xl flex  mt-4">
                ...
                <div class="w-full mx-2 md:mx-4">
                    <h4 class="text-xl font-semibold">
                        ...
                        <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                                <div class="hidden md:block font-bold text-gray-900">{{ $idea->user->name }}</div><div class="hidden md:block">&bull;</div>
                                <div> {{ $idea->created_at->diffForHumans() }}</div><div>&bull;</div>
                                <div>Category 1</div><div>&bull;</div>
                                <div class="text-gray-900">3 Comments</div>
                        </div>
                        <div x-data="{ isOpen: false }"
                        class="flex justify-between  items-center space-x-2 mt-4 md:mt-0 ">
                            <div
                             class="bg-gray-200 text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">open</div>
                            <button 
                            @click="isOpen = !isOpen"
                            class="relative bg-gray-100  border hover:bg-gray-200 rounded-full h-7 transition duration-200 ease-in py-2 px-3">
                                ...
                                class="absolute w-44 text-left font-semibold bg-white shadow-dialog rounded-xl z-10 py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0">
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-200 ease-in px-6 py-3 rounded-lg"> Mark as spam</a></li>
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-200 ease-in px-6 py-3 rounded-lg">Delete Post</a></li>
        ...
        <div class="buttons-container  flex items-center  md:justify-between justify-center mt-6">
            <div class="flex flex-row  items-center space-x-4 md:ml-6">
                        ...
                        x-data="{ isOpen: false }"
                            ...
                            @click="isOpen = !isOpen"
                                ...
                                class="flex items-center justify-center text-white
                                        h-11 w-32 text-sm bg-blue
                                       font-semibold rounded-xl border 
                                       border-blue hover:bg-blue-hover
                                ...
                                <form action="" class=" space-y-4 px-4 py-6">
                                    <div>
                                        <textarea name="post_comment" id="post_comment" cols="30" rows="4" 
                                            class="w-full text-sm bg-gray-100
                                            placeholder-gray-900 border-none px-4 py-6
                                            "
                                            placeholder=""
                                            >
                                        </textarea>
                                    ...
                                    <div class="flex flex-col md:flex-row items-center md:space-x-3">
                                       ...
                                       class="flex items-center justify-center w-full md:w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 mt-2 md:mt-0"
                                        > 
                                        <svg  class="text-gray-600 w-4 transform -rotate-45" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        x-data="{ isOpen: false }"
                            ...
                            @click="isOpen = !isOpen"
                                    ...
                                    type="button"
                                    class="flex items-center justify-center w-36 h-11 text-sm bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3  mt-0"
                                    ...
                                    <div
                                        ...
                                        class="absolute z-20 w-64 md:w-76 text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mt-2 right-0">
                                        <form action="" class=" space-y-4 px-4 py-6">
                                            <div class="space-y-2">
                                                <div>
        ...
        <div class="comments-container relative space-y-6 md:ml-22 pt-4 my-8 mt-1">
            <div class="comment-container relative shadow-card  transition duration-150 ease-in bg-white rounded-xl flex  mt-4">
                ...
                <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                    ...
                    <div class="w-full md:mx-4">
                            ...
                            <div class="text-gray-600 mt-3 line-clamp-3">Lorem ipsum dolor sit, amet consectetur</div>
                        <div class="flex items-center justify-between mt-6">
                            <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                                    <div class="font-bold text-gray-900">Karwan jabar</div><div>&bull;</div>
                                    <div>10 hours ago</div>
                                    
                            </div>
                            <div class="flex items-center space-x-2">
                                <button class="relative bg-gray-100  border hover:bg-gray-200 rounded-full h-7 transition duration-200 ease-in py-2 px-3">
                                    <svg  width="24" height="6"  fill="currentColor">
                                        <path d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0 100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z" 
                                        style="color:rgba(163,163,.5)"/>
                                    </svg>
            ...
            <div class="comment-container relative bg-white rounded-xl flex mt-4">
                <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
                    <div class="flex-none">
                        ...
                        <div class="text-center uppercase  text-blue text-xxs mt-1 font-bold">
                          Admin  
                        </div>
                    </div>
                    <div class="w-full mx-4">
                        <h4 class="text-xl font-semibold">
                            <a href="#" class="hover:underline"> Status changed to under </a>
                        </h4>
                            <div class="text-gray-600 mt-3 line-clamp-3">Lorem ipsum dolor sit, amet consectetur</div>
                        <div class="flex items-center justify-between mt-6">
                            <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                                    <div class="font-bold text-blue">Andrea</div><div>&bull;</div>
                                    <div>10 hours ago</div>
                            ...
                            <div class="flex items-center space-x-2">
                                <button class="relative bg-gray-100  border hover:bg-gray-200 rounded-full h-7 transition duration-200 ease-in py-2 px-3">
                                    ...
                                    <ul class="hidden absolute ml-8 text-left w-44 font-semibold bg-white shadow-dialog rounded-lg py-3">
                                        <li><a href="#" class="hover:bg-gray-100 block transition duration-200 ease-in px-6 py-3 rounded-lg"> Mark as spam</a></li>
                                        <li><a href="#" class="hover:bg-gray-100 block transition duration-200 ease-in px-6 py-3 rounded-lg">Delete Post</a></li>

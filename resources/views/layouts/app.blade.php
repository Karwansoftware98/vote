...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 text-sm bg-gray-background">
       <header class="flex flex-col mx-auto md:flex-row items-center justify-between px-8 py-4">
            <a href="#">
                <img src="{{ asset('images/lara.svg') }}" alt="">
            </a>
       ...
       <main class="container mx-auto max-w-custom flex flex-col md:flex-row">
           <div class="w-70  mx-auto md:mx-0  md:mr-5">
                <div class="md:sticky md:top-8 bg-white border-2 border-blue rounded-xl mt-16"
                style="
                ...
                "
                >
                    <div class="text-center md:px-6 py-2 pt-6" >
                    ...
                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                            <div>
                                <input type="text"  class="w-full text-sm bg-gray-100 rounded-lg border-none
                                placeholder-gray-900 px-4 py-2" placeholder=" Your Idea">
                            </div>
                            <div >
                                <select name="category_id" id="category_id" class="text-sm w-full rounded-xl px-4 py-2 border-none bg-gray-100">
                            ...
                            <div>
                                ...
                                class="w-full bg-gray-100 rounded-lg border-none
                                placeholder-gray-900 text-sm px-4 py-2 " placeholder="describe your idea">
                                </textarea>
                            </div>
                            <div class="flex items-center justify-between space-x-3">
                                <button type="button"
                                 class="flex items-center justify-center 
                                        w-1/2 h-11 text-xs bg-gray-200 
